...
def export_csv(request, etude_id):
    ...
    # En-têtes de base
    headers = ["numero_id", "genre", "date_naissance", "periode", "filled_by"]
...
def export_spss(request, etude_id):
    ...
    column_labels = {"numero_id": "Numéro patient", "genre": "Genre", "periode": "Période"}
    ...
    buffer = io.BytesIO()
    pyreadstat.write_sav(df, buffer, column_labels=column_labels)
